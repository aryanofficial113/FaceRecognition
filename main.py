...
# Updates the time in the GUI every 200 milliseconds
...
# Shows a contact email for support

def contact():
    mess._show(title='Contact us', message="Please contact us on : 'ashish.11.11.2004.chaudhary@gmail.com' ")


###################################################################################

# Verifies that the haarcascade_frontalface_default.xml file is available, essential for face detection
...
# Verifies the password before allowing access to train images
...
# Loads images and their labels from a specified directory for training purposes
...
# Saving Attendance (Follows 3 steps)
